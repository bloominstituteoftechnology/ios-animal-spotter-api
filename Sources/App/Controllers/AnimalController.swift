...
final class AnimalController {
    ...
    var animals: [Animal] = [
        Animal(id: 1,
               name: "Lion",
               timestamp: Date(timeIntervalSince1970: 1476381432),
               latitude: 41.0059666,
               longitude: -8.596247,
        ...
        Animal(id: 2,
               name: "Zebra",
               timestamp: Date(timeIntervalSince1970: 1538180415),
               latitude: 45.4401623,
        ...
        Animal(id: 3,
               name: "Flamingo",
               timestamp: Date(timeIntervalSince1970: 1483741219),
               latitude: 38.7080654,
               longitude: -9.3872558,
        ...
        Animal(id: 4,
               name: "Brown Meerkat",
               timestamp: Date(timeIntervalSince1970: 1548905617),
               latitude: 31.887402,
        ...
        Animal(id: 5,
               name: "Baboon",
               timestamp: Date(timeIntervalSince1970: 1367371199),
               latitude: 34.6911,
        ...
        Animal(id: 6,
               name: "Brown Bear",
               timestamp: Date(timeIntervalSince1970: 1408047986),
               latitude: 56.91683,
               longitude: -117.61945,
        ...
        Animal(id: 7,
               name: "Hyena",
               timestamp: Date(timeIntervalSince1970: 1444126635),
               latitude: 39.353118,
               longitude: -9.1143068,
        ...
        Animal(id: 8,
               name: "Squirrel",
               timestamp: Date(timeIntervalSince1970: 1529567628),
               latitude: 36.6850384,
        ...
        Animal(id: 9,
               name: "Python",
               timestamp: Date(timeIntervalSince1970: 1523244077),
               latitude: 49.689425,
        ...
        Animal(id: 10,
               name: "Chimpanzee",
               timestamp: Date(timeIntervalSince1970: 1450987325),
               latitude: 12.6417,
               longitude: 123.9092,
        ...
        Animal(id: 11,
               name: "Crab",
               timestamp: Date(timeIntervalSince1970: 1486234736),
               latitude: 11.8859782,
               longitude: -86.054235,
        ...
        Animal(id: 12,
               name: "Jaguar",
               timestamp: Date(timeIntervalSince1970: 1395166126),
               latitude: -10.1429097,
        ...
        Animal(id: 13,
               name: "Eagle",
               timestamp: Date(timeIntervalSince1970: 1456242326),
               latitude: 34.5553494,
               longitude: 69.207486,
        ...
        Animal(id: 14,
               name: "Dove",
               timestamp: Date(timeIntervalSince1970: 1450402567),
               latitude: 9.3125556,
        ...
        Animal(id: 15,
               name: "Dolphin",
               timestamp: Date(timeIntervalSince1970: 1525001519),
               latitude: 6.5592478,
        ...
        Animal(id: 16,
               name: "Deer",
               timestamp: Date(timeIntervalSince1970: 1433710478),
               latitude: 7.0739678,
        ...
        Animal(id: 17,
               name: "Tortoise",
               timestamp: Date(timeIntervalSince1970: 1371092000),
               latitude: 53.7002,
               longitude: 102.7117,
        ...
        Animal(id: 18,
               name: "Seal",
               timestamp: Date(timeIntervalSince1970: 1497998321),
               latitude: 26.655026,
        ...
        Animal(id: 19,
               name: "Parrot",
               timestamp: Date(timeIntervalSince1970: 1527470745),
               latitude: 10.0016057,
        ...
        Animal(id: 20,
               name: "Lizard",
               timestamp: Date(timeIntervalSince1970: 1375437692),
               latitude: 29.995762,
